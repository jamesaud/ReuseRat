# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-02-27 20:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_type', models.CharField(choices=[('Check', 'Check'), ('Direct Deposit', 'Direct Deposit'), ('Paypal', 'Paypal')], default='Check', max_length=255, verbose_name='Payment Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('address_line', models.CharField(max_length=30, verbose_name='Address Line #')),
                ('address_apartment', models.CharField(max_length=30, verbose_name='Apartment #')),
