...
from reuserat.users.tests.factories import UserCompleteFactory
...
class TestOrderOrderReceiver(BaseWebhookTestCase):
    def setUp(self):
        ...
        self.user = UserCompleteFactory()  # Create user with valid stripe account to transfer funds over to.
    ...
    def test_order_payment(self):
        ...
        self.assertEqual(transaction.amount,
                         balance_in_dollars)  # The transaction amount should not be added a second time.
