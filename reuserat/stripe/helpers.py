...
def update_payment_info(account_id, account_token, user_object):
    ...
    try:
        ...
        account.display_name = user_object.first_name
        ...
        acct = StripeAccount.objects.filter(pk=account_id).update(account_number_token=account_token)

        return account

    except stripe.error.InvalidRequestError as e:
        print("Invalid parameters were supplied to Stripe")
